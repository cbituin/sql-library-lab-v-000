...
def select_name_and_series_subgenres_of_authors
  "SELECT Authors.name, Subgenres.name FROM series INNER JOIN authors, subgenre ON Series.author_id = Authors.id, Series.subgenre_id = Subgenres.id GROUP BY Authors.name, Subgenres.name;"
end
